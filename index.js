...
// Deletando pelo id enviado no body da requisição e customizando a messagem
// para aparecer o fullName do autor deletado
...
app.get('/books/:id', async (req, res) => {
  const authorBookId = parseInt(req.params.id, 10);
...
app.post('/books', async (req, res) => {
  ...
  if (!existsAuthor) return res.status(404).json({ message: 'Not Found' });
